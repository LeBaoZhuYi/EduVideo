<template>
  <div id="person-info">
    <div id="header">
      <span id="my_name">{{stuName}}的个人中心</span>
    </div>
    <div id="content">
      <div class="scroll">
        <div class="scrollContainer" id="scrollContainer">
          <el-carousel :autoplay=false trigger="click">
            <el-carousel-item v-for="item in 4" :key="item">
              <div class="panel" id="1" v-show="item == 1" style="font-size: 20px">
              ...
              <div class="panel hide" id="2" v-show="item == 2" style="font-size: 20px">
                <h1>个人信息</h1>
              ...
              <div class="panel hide" id="3" v-show="item == 3" style="font-size: 20px">
                <h1>课程情况</h1>
