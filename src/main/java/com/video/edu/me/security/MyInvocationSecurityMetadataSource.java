...
import com.video.edu.me.security.AntUrlPathMatcher;
//import com.video.edu.me.security.tool.UrlMatcher;
...
public class MyInvocationSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    private void loadResourceDefine() {
        ...
        attsno.add(new SecurityConfig("ROLE_TEACHER"));
        resourceMap.put("/admin/**", attsno);
    }
